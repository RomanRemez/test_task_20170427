...
public class ShipmentServiceImpl implements ShipmentService {
    ...
    @Autowired
    public ShipmentServiceImpl(ShipmentDao shipmentDao, ClientDao clientDao, ParcelService parcelService,
    ...
    public ShipmentDto update(long id, ShipmentDto shipmentDto) {
        ...
        target.getParcels().addAll(source.getParcels());
        source.setParcels(target.getParcels());
        source.setId(id);
        try {
